...
Toda la información relacionada a los gastos (fecha, monto, categorías, fotos) será creada y guardada localmente en cada dispositivo móvil. Cada dispositivo podrá enviar al servidor reportes de gastos en forma de archivos PDF. La comunicación entre la aplicación móvil y el servidor se hace por medio de servicios web que presta este último.
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.65,type=png,ext=.png,read=.png]{imagenes/class_diagram_mobile}
...
\begin{figure}[ht]
  \centering
  \includegraphics[scale=0.65,type=png,ext=.png,read=.png]{imagenes/class_diagram_server}
