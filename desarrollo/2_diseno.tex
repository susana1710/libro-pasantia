...
Para especificar cada uno de estos requerimientos, así como su prioridad, se realizó una primera versión del Documento de Historias de Usuario (\textit{Product Backlog}). Éste fue modificándose a lo largo del desarrollo del proyecto. Para más información de la versión final del documento, ver apéndice~\ref{chap:Product Backlog}.
...
\begin{itemize}
	...
	\item \textbf{Role}: representa el rol que tiene un usuario dentro del sistema, el cual indica 	qué privilegios tendrá. Almacena información de su \textit{id}, nombre y descripción.
\end{itemize} 
