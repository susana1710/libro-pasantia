...
\item Se agregó una funcionalidad para tomar fotos relacionadas a un ingreso/gasto.
\item Se agregó una funcionalidad para poder asociar un ingreso/gasto a una categoría existente.
...
\subsubsection{Resultados}
\begin{itemize}
\item Se creó una vista para mostrar una lista con los gastos y otra con los ingresos del mes actual.
\item Se agregó una funcionalidad para ver los detalles de un ingreso/gasto ya existente, y poder editarlo.
\item Se agregó una funcionalidad para eliminar ingresos/gastos
...
\item Se implementó una funcionalidad para listar las cuentas del usuario.
\item Se implementó una funcionalidad para cambiar de cuenta.
\item Se implementó una funcionalidad para editar el nombre de una cuenta existente.
\item Se implementó una funcionalidad para eliminar cuentas existentes.
\item Se implementó una funcionalidad para cambiar el estado de una cuenta: activa o archivada.
\item Se implementó una funcionalidad para ver una lista con los ingresos y gastos de una cuenta.
...
\subsubsection{Resultados}
\begin{itemize}
\item Se agregó una funcionalidad para ver las fotos de un ingreso/gasto.
\item Se agregó una funcionalidad para borrar las fotos de un ingreso/gasto.
\item Se agregó una funcionalidad para cambiar la ubicación en el dispositivo de las fotos tomadas de un ingreso/gasto.
\item Se agregó una funcionalidad para crear una categoría.
\item Se agregó una funcionalidad para eliminar una categoría existente.
\item Se agregó una funcionalidad para editar una categoría existentes.
\end{itemize}
...
\subsubsection{Resultados}
\begin{itemize}
\item Se implementó una funcionalidad para listar los ingresos/gastos de una cuenta en el rango de fecha ingresado por el usuario.
...
\item Se creó una funcionalidad para compartir el reporte con la lista de gastos e ingresos, incluyendo las fotos, de la cuenta en el rango de fecha ingresado.
\item Se creó una funcionalidad para compartir el reporte con la lista de gastos e ingresos, sin incluir las fotos, de la cuenta en el rango de fecha ingresado.
\item Se creó una funcionalidad para compartir el reporte con el balance total de las categorías de la cuenta en el rango de fecha ingresado.
\end{itemize}
...
\item Se creó un servicio web al cual la aplicación móvil se puede conectar para la autenticación de usuarios.
\item Se creó un servicio web a través del cual la aplicación móvil puede enviar reportes de gastos.
