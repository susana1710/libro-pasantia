...
Además de esto, la herramienta utilizada para el desarrollo del servidor trae consigo algunas funcionalidades por defectos que permiten iniciar sesión, agregar un usuario, editar un usuario y eliminar un usuario.
